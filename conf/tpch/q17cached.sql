...
from (select l_partkey as t_partkey, 0.2 * avg(l_quantity) as t_avg_quantity from lineitem_cached group by
l_partkey) t join (select l_quantity, l_partkey, l_extendedprice from part_cached p join lineitem_cached l
